import { useEffect, useRef, useState, type ChangeEvent, type FormEvent, type ReactNode, type Ref } from 'react';
            ...
            <div className="volume-row">
              ...
              <div className="range-shell">
                ...
                <input
                  ...
                  max="100"
                  value={volume}
                  onChange={event => handleVolumeInput(Number(event.target.value) / 100)}
                  aria-label="音量"
                />
              </div>
            </div>
